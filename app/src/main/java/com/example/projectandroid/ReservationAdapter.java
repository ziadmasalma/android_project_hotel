...
public class ReservationAdapter extends ArrayAdapter<Reservation> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView imageView = convertView.findViewById(R.id.imagereservation);
        TextView usernameTextView = convertView.findViewById(R.id.username);
        TextView stateTextView = convertView.findViewById(R.id.state);
        ...
        String imageUrl = reservations.get(position).getImageUrl();
    ...
    private class PayReservationTask extends AsyncTask<Void, Void, String> {
        ...
        public PayReservationTask(Reservation reservation) {
    ...
    private void insertPriceIntoPayresTable(double price) {
        String url = "http://10.0.2.2:80/android/respay.php";
...
//    }
    ...
    private void updateRoomState(int roomId ) {
        ...
        // Create a request to update the room state in the "room" table
        StringRequest request = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
